...
export default function BinancePayScreen() {
  ...
  const quickAmounts = ["100 USDC", "500 USDC", "1000 USDC", "Max"];
  ...
  const handleQuickAmountSelect = (quickAmount: string) => {
    if (quickAmount === "Max") {
      ...
      const numericAmount = quickAmount.replace(" USDC", "");
  ...
  const handleTopUpNow = () => {
    // TODO: Implement Binance Pay logic
    console.log(`Binance Pay: ${amount} ${selectedCurrency.symbol}`);
  };
      ...
      >
        ...
        <View style={styles.amountSection}>
          ...
          <View style={styles.amountDisplay}>
            <Text style={styles.amountValue}>{amount} USDC</Text>
          ...
          {/* Range Display */}
          <Text style={styles.rangeText}>0.01 USDC - 50000 USDC</Text>
...
const styles = StyleSheet.create({
  ...
  topUpButton: {
    ...
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: "#F0B90B", // Binance yellow color
    borderRadius: 15,
    paddingVertical: 16,
  ...
  topUpIcon: {
    ...
    height: 20,
    marginRight: 8,
    tintColor: "#000000", // Black tint for visibility on yellow background
  },
  topUpText: {
    fontSize: 18,
    fontWeight: "600",
    color: "#000000", // Black text for visibility on yellow background
  },
  numberPad: {
    marginBottom: 80,
  },
